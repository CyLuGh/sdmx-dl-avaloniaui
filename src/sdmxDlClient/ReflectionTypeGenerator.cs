...
{
    /// <summary>
    /// Create "real" classes at runtime
    /// </summary>
    public static class ReflectionTypeGenerator
    {
        ...
        public static Type GenerateTypedObject( IEnumerable<(string name, Type propertyType)> elements ,
            IEnumerable<(string name, Type parameterType)>? constructorParameters = null ,
            IEnumerable<Type>? interfaces = null )
        {
            // https://msdn.microsoft.com/en-us/library/2sd82fz7.aspx
            var myAsmName = new AssemblyName { Name = "sdmxDlDynamic" };
